...
const PersonalContent = () => (
  <span className="opacity-0 animate-fadeInUp">
    <div className="flex flex-col md:flex-row md:items-baseline gap-2 mb-4 px-12 md:px-0">
      <span className="text-base md:text-lg">howdy, i'm</span>
      <SparklesText 
        text="helen huang"
        colors={{ first: "#76bb5d", second: "#9774cc" }}
        className="text-4xl md:text-8xl font-bold text-[#ff6b35]"
      />
    </div>
    <div className="text-base md:text-lg px-12 md:px-0">
...
const ProfessionalContent = () => (
  <span className="opacity-0 animate-fadeInUp">
    <div className="flex items-baseline gap-2 mb-4 px-12 md:px-0">
      <span>Hello, I'm</span>
      <SparklesText 
        text="Helen Huang"
        colors={{ first: "#76bb5d", second: "#9774cc" }}
        className="text-5xl md:text-7xl font-bold text-[#ff6b35]"
      />
    </div>
...
export function Header() {
  ...
  return (
    <header className="h-screen w-full flex flex-col items-center justify-center relative">
      <div className="relative z-10 max-w-3xl px-8 md:px-4">
