...
export const nowNote: Note = {
  ...
  content: `made it to NYC!! am currently in the mood to just enjoy the hot builder summer and push back job searching for now. maybe i build conviction in something else instead? or maybe not???
